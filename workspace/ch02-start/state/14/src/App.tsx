  ...
  const [user, setUser] = useState({
    ...
    const handleAddressChange = (event: React.ChangeEvent<HTMLInputElement>)=> {
      ...
      */
      ...
      // 주소가 변경될 경우 기대 값
      console.log('user', user === newUser); //true
      ...
      console.log('회사', user.extra.addressBook[0] === newUser.extra.addressBook[0]); //true
      console.log('회사 주소', user.extra.addressBook[0].value === newUser.extra.addressBook[0].value); //true
      ...
      console.log('예전 회사 정보', user.extra.addressBook[0]); //true
      console.log('수정된 회사 정보', newUser.extra.addressBook[0]); //true
